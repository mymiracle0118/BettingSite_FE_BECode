showMediaPlayer(tvData);

function showMediaPlayer(tvData){
    if(platform == "ios"){
        var webrtcPlayer = null;
        webrtcPlayer = new UnrealWebRTCPlayer("p1", tvData.camstring, "", tvData.IP, tvData.port, tvData.ssl, true, tvData.ptype);
        ...
        {
            RunPlayer("p1", '100%', '100%', tvData.IP, tvData.port, tvData.ssl, tvData.camstring, "", true, true, 0.01, "", false);    
