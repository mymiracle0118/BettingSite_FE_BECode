  ...
  <div class="detail-page-container five-cricket"
        ...
        <div class="scorecard d-none-desktop mt-1 mb-1" v-if="gameDetail.scard == 1 && scoreboardData.isfinished == '0'">
          <div class="scorecard-row row row5">
            ...
            <div class="col-12 text-center">
              ...
              <div>
                <span v-for="ball in scoreboardData.balls" v-if="ball !== '' " class="ball-runs mr-1"
    ...
    <div class="casino-video">
      ...
      <div class="video-box-container">
        ...
        <template v-else>
          <div class="five-video-baner" v-if="gameType">
            <img :src="`${imgPath}front/img/${gameType}-bg.jpg`">
      ...
      <div class="casino-video-right-icons">
        <div class="casino-video-home-icon" title="Refresh" @click="reloadPage()" v-if="!gameDetail.iplay">
    ...
    <b-modal ref="placebet-modal" hide-footer title="BET SLIP" @hide="$store.commit('resetBetData')"
      ...
      <ValidationObserver tag="div" v-slot="{ invalid }">
        <template
          v-if="($route.name == 'gameDetail' || $route.name == 'virtualCricket') && $store.state.bet && $store.state.bet != null">
        ...
        ServiceApi.callApi("api/front/gamedetail", {
          ...
          .then(response => {
            if (response.status == 200) {
              ...
              // this.tvUrl = '/mediaplayer/' + this.gameType + '?ip=' + IP_ADDRESS;
