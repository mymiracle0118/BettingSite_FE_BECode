<template>
    <div class="report-box casino-box w-100 casino-fantasy" :class="{'frame-open':$store.state.fantacy.showFrame}">
                            ...
                            <div class="container-fluid container-fluid-5">
                                <div class="row row5">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <template v-if="gmid == 'ludo-club'">
                                            <ludo-club />
                                        </template>

                                        <template v-if="gmid == 'rummy'">
                                            <rummy-club />
                                        </template>

                                        <template v-if="gmid == 'ludo-lands'">
                                            <ludo-lands />
                                        </template>
...
<script>
    ...
    import LudoClub from '@/pages/fantacy/LudoClub'
    import RummyClub from '@/pages/fantacy/RummyClub'
    import LudoLands from '@/pages/fantacy/LudoLands'
                ...
                ServiceApi.callApi("api/front/casino/other", {
                    ...
                    .then(response => {
                        if (response.status == 200) {
                           ...
                           //  this.casinoList.push({"gmid":"ludo-lands","gname":"Ludo Lands","imgpath":"ludo-lands.jpg","sno":5,"tabno":7})
