                    ...
                    <div class="teen20left">
                        ...
                        <div class="casino-bl-box">
                            ...
                            <div class="back casino-bl-box-item" :class="{'suspended': highCard[0].gstatus != 'OPEN'}"
                                @click="setBetData(highCard[0].nat, highCard[0].b, mId, highCard[0].sid, highCard[0].subtype, 0, 'back', gameType, highCard[0].gstatus, highCard[0].min, highCard[0].max)">
                            ...
                            <div class="back casino-bl-box-item" :class="{'suspended': colorPlus[0].gstatus != 'OPEN'}"
                                @click="setBetData(colorPlus[0].nat, colorPlus[0].b, mId, colorPlus[0].sid, colorPlus[0].subtype, 0, 'back', gameType, colorPlus[0].gstatus, colorPlus[0].min, colorPlus[0].max)">
                    ...
                    <div class="teen20right">
                        ...
                        <div class="casino-bl-box">
                            ...
                            <div class="back casino-bl-box-item" :class="{'suspended': highCard[1].gstatus != 'OPEN'}"
                                @click="setBetData(highCard[1].nat, highCard[1].b, mId, highCard[1].sid, highCard[1].subtype, 0, 'back', gameType, highCard[1].gstatus, highCard[1].min, highCard[1].max)">
                            ...
                            <div class="back casino-bl-box-item" :class="{'suspended': colorPlus[1].gstatus != 'OPEN'}"
                                @click="setBetData(colorPlus[1].nat, colorPlus[1].b, mId, colorPlus[1].sid, colorPlus[1].subtype, 0, 'back', gameType, colorPlus[1].gstatus, colorPlus[1].min, colorPlus[1].max)">
                ...
                <div class="sin-khal-box">
                    ...
                    <div class="casino-bl-box">
                        <div class="back casino-bl-box-item" :class="{'suspended': lucky9[0].gstatus != 'OPEN'}"
                            @click="setBetData(lucky9[0].nat, lucky9[0].b, mId, lucky9[0].sid, lucky9[0].subtype, 0, 'back', gameType, lucky9[0].gstatus, lucky9[0].min, lucky9[0].max)">
                            <span class="casino-box-odd ">{{ lucky9[0].b }}</span>
                        </div>
                        <div class="lay casino-bl-box-item" :class="{'suspended': lucky9[0].gstatus != 'OPEN'}"
                            @click="setBetData(lucky9[0].nat, lucky9[0].l, mId, lucky9[0].sid, lucky9[0].subtype, 0, 'lay', gameType, lucky9[0].gstatus, lucky9[0].min, lucky9[0].max)">
