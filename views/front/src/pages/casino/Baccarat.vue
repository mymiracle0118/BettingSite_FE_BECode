                ...
                <div class="baccarat-bets-odds">
                    <div class="baccarat-odds">
                        <div class="baccarat-odd-block" >
                            <div class="baccarat-odd-name" :class="{'suspended': mainData[5].gstatus != 'OPEN'}" @click="setBetData(5, 'back')">{{ mainData[5].nat }} {{ parseFloat(mainData[5].b) }}:1</div>
                        ...
                        <div class="baccarat-odd-block">
                            <div class="baccarat-odd-name" :class="{'suspended': mainData[6].gstatus != 'OPEN'}" @click="setBetData(6, 'back')">{{ mainData[6].nat }} {{ parseFloat(mainData[6].b) }}:1</div>
                        ...
                        <div class="baccarat-odd-block">
                            <div class="baccarat-odd-name" :class="{'suspended': mainData[7].gstatus != 'OPEN'}" @click="setBetData(7, 'back')">{{ mainData[7].nat }} {{ parseFloat(mainData[7].b) }}:1</div>
                        ...
                        <div class="baccarat-odd-block">
                            <div class="baccarat-odd-name" :class="{'suspended': mainData[8].gstatus != 'OPEN'}" @click="setBetData(8, 'back')">{{ mainData[8].nat }} {{ parseFloat(mainData[8].b) }}:1</div>
