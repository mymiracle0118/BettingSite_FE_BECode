                    ...
                    <div class="teen1dayleft">
                        <div class="seven-up-down-box">
                            <div class="up-box"
                                ...
                                @click="setBetData(upDown[1].nat, upDown[1].b, mId, upDown[1].sid, upDown[1].subtype, upDown[1].sid, 'back', gameType, upDown[1].gstatus, upDown[1].min, upDown[1].max)">
                            ...
                            <div class="down-box"
                                ...
                                @click="setBetData(upDown[0].nat, upDown[0].b, mId, upDown[0].sid, upDown[0].subtype, upDown[0].sid, 'back', gameType, upDown[0].gstatus, upDown[0].min, upDown[0].max)">
                                <div class="up-down-book"
                    ...
                    <div class="teen1dayright">
                        <div class="seven-up-down-box">
                            <div class="up-box"
                                ...
                                @click="setBetData(upDown[3].nat, upDown[3].b, mId, upDown[3].sid, upDown[3].subtype, upDown[3].sid, 'back', gameType, upDown[3].gstatus, upDown[3].min, upDown[3].max)">
                                <div class="up-down-book"
                            ...
                            <div class="down-box"
                                ...
                                @click="setBetData(upDown[2].nat, upDown[2].b, mId, upDown[2].sid, upDown[2].subtype, upDown[2].sid, 'back', gameType, upDown[2].gstatus, upDown[2].min, upDown[2].max)">
                                <div class="up-down-book"
