                                    ...
                                    <div class="casino-box-row">
                                        ...
                                        <div class="casino-bl-box">
                                            ...
                                            <div class="lay casino-bl-box-item"
                                                :class="{'suspended': main[i-1].gstatus != 'OPEN'}"
                                                @click="setBetData(main[i-1].nat, main[i-1].l, mId, main[i-1].sid, main[i-1].subtype, 0, 'lay', gameType, main[i-1].gstatus, main[i-1].min, main[i-1].max)">
                                                <span class="casino-box-odd">{{ main[i-1].l }}</span>
                                            </div>
                                        </div>
                                        <div class="casino-nation-name" v-casinobook="{sid: main[i-1].sid}">
                                            0
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="casino-bl-box ">
                                <div class="casino-bl-box-item casino-odds-name">
                                    ...
                                    <span class="float-right"
                                        v-casinofancybook="{sid: fancy1[0].sid, subid: 0}">0</span>
                                </div>
                                <div class="back casino-bl-box-item" :class="{'suspended': fancy1[0].gstatus != 'OPEN'}"
                                    @click="setBetData(fancy1[0].nat, fancy1[0].b, mId, fancy1[0].sid, fancy1[0].subtype, 0, 'back', gameType, fancy1[0].gstatus, fancy[0].min, fancy[0].max)">
                                    <span class="casino-box-odd">{{ fancy1[0].b }}</span>
                                </div>
                                <div class="lay casino-bl-box-item" :class="{'suspended': fancy1[0].gstatus != 'OPEN'}"
                                    @click="setBetData(fancy1[0].nat, fancy1[0].l, mId, fancy1[0].sid, fancy1[0].subtype, 0, 'lay', gameType, fancy1[0].gstatus, fancy[0].min, fancy[0].max)">
                    ...
                    <div class="row row5 ">
                        <div class="col-lg-4 col-12 d-none-small">
                            <div class="casino-box-row">
                                ...
                                <div class="casino-bl-box">
                                    <div class="back casino-bl-box-item"
                                        :class="{'suspended': fancy1[0].gstatus != 'OPEN'}"
                                        @click="setBetData(fancy1[0].nat, fancy1[0].b, mId, fancy1[0].sid, fancy1[0].subtype, 0, 'back', gameType, fancy1[0].gstatus, fancy[0].min, fancy[0].max)">
                                        <span class="casino-box-odd">{{ fancy1[0].b }}</span>
                                    </div>
                                    <div class="lay casino-bl-box-item"
                                ...
                                <div class="casino-nation-name" v-casinofancybook="{sid: fancy1[0].sid, subid: 0}">
                                    0
                                </div>
                                <!-- <div class="teen1daycasino-container justify-content-end casino-min-max w-100">
                                    <div>R:<span v-kval="{size: fancy1[0].min}"></span> - <span v-kval="{size: fancy1[0].max}"></span></div>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="casino-cards text-center mt-1">
                                <div class="casino-card-item">
                                    ...
                                    <div class="casino-book" v-casinofancybook="{sid: fancy[2].sid, subid: 0}">0</div>
                                </div>
                                <div class="casino-card-item">
                                    ...
                                    <div class="casino-book" v-casinofancybook="{sid: fancy[3].sid, subid: 0}">0</div>
                                </div>
                                <div class="casino-card-item">
                                    ...
                                    <div class="casino-book" v-casinofancybook="{sid: fancy[4].sid, subid: 0}">0</div>
                                </div>
                                <div class="casino-card-item">
                                    ...
                                    <div class="casino-book" v-casinofancybook="{sid: fancy[5].sid, subid: 0}">0</div>
                                </div>
                            </div>
                            <!-- <div class="teen1daycasino-container justify-content-end casino-min-max w-100">
