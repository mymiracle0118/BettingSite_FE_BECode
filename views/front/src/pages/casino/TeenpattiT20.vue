                    ...
                    <div class="teen20casino-container d-none-small">
                        <div class="teen20left">
                            ...
                            <div class="casino-bl-box casino-bl-box-title">
                                ...
                                <div class="casino-bl-box-item">
                                    <span>3 Baccarat A</span>
                                </div>
                                <div class="casino-bl-box-item">
                                    <span>Total A</span>
                                </div>
                                <div class="casino-bl-box-item">
                                    <span>Pair Plus A</span>
                                </div>
                            </div>
                            <div class="casino-bl-box">
                                ...
                                <div class="back casino-bl-box-item" :class="{'suspended': khal[0].gstatus != 'OPEN'}"
                                    ...
                                    <span v-casinofancybook="{sid: khal[0].sid, subid: 0}">0</span>
                                </div>
                                    ...
                                    <div class="casino-rb-box-player blackbox back"
                                        ...
                                        <div class="text-right">
                                            ...
                                            <span class="text-right"
                                                v-casinofancybook="{sid: redBlack[0].sid, subid: 0}">0</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="casino-rb-box redcontainer">
                                    <div class="casino-rb-box-player redbox back"
                                        ...
                                        <div class="text-right">
                                            ...
                                            <span class="text-right"
                                                v-casinofancybook="{sid: redBlack[1].sid, subid: 0}">0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="teen20right">
                            ...
                            <div class="casino-bl-box casino-bl-box-title">
                                ...
                                <div class="casino-bl-box-item">
                                    <span>3 Baccarat B</span>
                                </div>
                                <div class="casino-bl-box-item">
                                    <span>Total B</span>
                                </div>
                                <div class="casino-bl-box-item">
                                    <span>Pair Plus B</span>
                                </div>
                            </div>
                            <div class="casino-bl-box">
                                ...
                                <div class="back casino-bl-box-item" :class="{'suspended': khal[1].gstatus != 'OPEN'}"
                                    ...
                                    <span v-casinofancybook="{sid: khal[1].sid, subid: 0}">0</span>
                                </div>
                                ...
                                <div class="casino-rb-box blackcontainer">
                                    <div class="casino-rb-box-player blackbox back"
                                        ...
                                        <div class="text-right">
                                            ...
                                            <span class="text-right"
                                                v-casinofancybook="{sid: redBlack[2].sid, subid: 0}">0</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="casino-rb-box redcontainer">
                                    <div class="casino-rb-box-player redbox back"
                                        ...
                                        <div class="text-right">
                                            ...
                                            <span class="text-right"
                                                v-casinofancybook="{sid: redBlack[3].sid, subid: 0}">0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bet-slip pl-0 pr-0">
                        <div class="bet-team mt-0">
                            ...
                            <span class="float-right"
                                v-if="$store.state.casinoBet.subType != 'Pair'">{{ $store.state.casinoBet.uRate }}</span>
                        </div>
                    </div>
