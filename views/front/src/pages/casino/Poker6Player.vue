                                                ...
                                                <div class="casino-box-row">
                                                    ...
                                                    <div class="poker6box"
                                                        ...
                                                        <div class="casino-nation-name">
                                                            ...
                                                            <span class="float-right mr-1 flex-odds">
                                                                <b class="d-block text-right">{{ main[i-1].b }}</b>
                                                                <span class="w-100 text-right"
                                                                    v-casinofancybook="{sid: main[i-1].sid, subid: 0}">0</span>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="poker6box"
                                                        ...
                                                        <div class="casino-nation-name">
                                                            ...
                                                            <div class="flex-odds">
                                                                ...
                                                                <span class="w-100 text-right"
                                                                    v-casinofancybook="{sid: main[i+5].sid, subid: 0}">0</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="casino-box-row">
                                            <div class="poker6box" :class="{'suspended': main[i-1].gstatus != 'OPEN'}"
                                                ...
                                                <div class="casino-nation-name">
                                                    ...
                                                    <span class="float-right mr-1"><b>{{ main[i-1].b }}</b></span>
                                                </div>
                                            </div>
                                            <div class="poker6val">
                                ...
                                <template v-for="(i, key) in 9">
                                    <div class="casino-col-container" :key="`pattern-${key}`">
                                        <div class="casino-box-row">
                                            <!-- <div class="w-100 mb-1 pr">
                                                <div class="float-right">
                                                    <i class="fas fa-info-circle" data-toggle="collapse" :data-target="`#pattern-${i+5}`"></i>
                                                    <div :id="`pattern-${i+5}`" class="collapse icon-range">
                                                        R:<span v-kval="{size: main[i+5].min}"></span>-<span
                                                            v-kval="{size: main[i+5].max}"></span>
                                                    </div>
                                    ...
                                    <!-- <div class="casino-col-container" :key="`pattern-${key}`">
                                        <div class="casino-box-row">
                                            <div class="poker6box" :class="{'suspended': main[i+5].gstatus != 'OPEN'}"
                                                @click="setBetData(main[i+5].nat, main[i+5].b, mId, main[i+5].sid, main[i+5].subtype, 0, 'back', gameType, main[i+5].gstatus)">
                                                <div class="casino-nation-name">
                                                    <b>{{ main[i+5].nat }}</b>
                                                    <span class="float-right mr-1"><b>{{ main[i+5].b }}</b></span>
                                                </div>
                                            </div>
                                            <div class="poker6val">
                ...
                ServiceApi.callApi("api/front/casino/data", {
                    ...
                    .then(response => {
                        if (response.status == 200) {
                            ...
                            this.getUserBook()
                            // this.exp = _.get(this.$s tore.state.user, 'exp', 0)
