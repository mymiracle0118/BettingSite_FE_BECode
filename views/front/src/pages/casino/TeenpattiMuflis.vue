                                ...
                                <div class="casino-box-row">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item" :class="{'suspended': muflis[0].gstatus != 'OPEN'}"
                                            @click="setBetData(muflis[0].nat, muflis[0].b, mId, muflis[0].sid, muflis[0].subtype, 0, 'back', gameType, muflis[0].gstatus, muflis[0].min, muflis[0].max)">
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item" :class="{'suspended': top9[0].gstatus != 'OPEN'}"
                                            @click="setBetData(top9[0].nat, top9[0].b, mId, top9[0].sid, top9[0].subtype, 0, 'back', gameType, top9[0].gstatus, top9[0].min, top9[0].max)">
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item" :class="{'suspended': baccarat[0].gstatus != 'OPEN'}"
                                            @click="setBetData(baccarat[0].nat, baccarat[0].b, mId, baccarat[0].sid, baccarat[0].subtype, 0, 'back', gameType, baccarat[0].gstatus, baccarat[0].min, baccarat[0].max)">
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item" :class="{'suspended': muflis[1].gstatus != 'OPEN'}"
                                            @click="setBetData(muflis[1].nat, muflis[1].b, mId, muflis[1].sid, muflis[1].subtype, 0, 'back', gameType, muflis[1].gstatus, muflis[1].min, muflis[1].max)">
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item" :class="{'suspended': top9[1].gstatus != 'OPEN'}"
                                            @click="setBetData(top9[1].nat, top9[1].b, mId, top9[1].sid, top9[1].subtype, 0, 'back', gameType, top9[1].gstatus, top9[1].min, top9[1].max)">
                                ...
                                <div class="casino-box-row">
                                    ...
                                    <div class="casino-bl-box">
                                        <div class="back casino-bl-box-item" :class="{'suspended': baccarat[1].gstatus != 'OPEN'}"
                                            @click="setBetData(baccarat[1].nat, baccarat[1].b, mId, baccarat[1].sid, baccarat[1].subtype, 0, 'back', gameType, baccarat[1].gstatus, baccarat[1].min, baccarat[1].max)">
                ...
                <!-- <div class="teen20casino-container">
                    <div class="teen20left">
                        ...
                        <div class="casino-bl-box">
                            ...
                            <div class="muflis-box">
                                <img :src="`${imgPath}front/img/top9.png`">
                                <div class="casino-bl-box">
                                    <div class="back casino-bl-box-item "
                                        :class="{'suspended': top9[0].gstatus != 'OPEN'}"
                                        @click="setBetData(top9[0].nat, top9[0].b, mId, top9[0].sid, top9[0].subtype, 0, 'back', gameType, top9[0].gstatus, top9[0].min, top9[0].max)">
                                        <span class="casino-box-odd ">{{ top9[0].b }}</span>
                                        <span v-casinofancybook="{sid: top9[0].sid, subid: 0}">0</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="teen20right">
                        ...
                        <div class="casino-bl-box">
                            ...
                            <div class="muflis-box">
                                ...
                                <div class="casino-bl-box">
                                    <div class="back casino-bl-box-item "
                                        :class="{'suspended': top9[1].gstatus != 'OPEN'}"
                                        @click="setBetData(top9[1].nat, top9[1].b, mId, top9[1].sid, top9[1].subtype, 0, 'back', gameType, top9[1].gstatus, top9[1].min, top9[1].max)">
                                        <span class="casino-box-odd ">{{ top9[1].b }}</span>
                                        <span v-casinofancybook="{sid: top9[1].sid, subid: 0}">0</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bet-slip pl-0 pr-0">
                        <div class="bet-team mt-0">
                            ...
                            <span class="float-right"
                                v-if="$store.state.casinoBet.subType != 'top9'">{{ $store.state.casinoBet.uRate }}</span>
                        </div>
                    </div>
