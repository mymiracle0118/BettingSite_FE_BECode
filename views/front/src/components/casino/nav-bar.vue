<template>
  <header class="header header-casino">
    <!-- <div class="menu-button-mobile d-none-desktop" @click="$router.go(-1)">
    ...
    <!-- <template v-if="showFixture"> -->
      <div class="upcoming-fixure d-none-mobile">
        ...
        <div class="fixure-box-container">
          <div id="carousel1" class="carousel vert slide" data-ride="carousel" data-interval="3000">
    ...
    <div class="float-right header-right">
      ...
      <div class="username-info d-none-desktop">
        ...
        <div class="collapse user-dropdown" id="user-dropdown">
          <template v-if="adminSettins">
            <template v-if="(adminSettins.button2 && adminSettins.button2.show) || (adminSettins.button3 && adminSettins.button3.show)">
      ...
      <transition name="custom-classes-transition"
        ...
        <div class="close-frame-fantacy" @click="closeCasino()" v-if="$store.state.fantacy.showFrame"><i class="fas fa-times"></i></div>
      </transition>
    </div>
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.$store.state.rdisplay) {
        ...
        //           this.welcomebanner =
        //             BUCKET_PATH + "common/wel-banner/" + response.data.t1[0].bimg;
