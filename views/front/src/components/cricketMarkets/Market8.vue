    ...
    <div class="market-6">
                            ...
                            <div class="fancy-tripple">
                                ...
                                <div class="bet-table-row" :data-title="section.gstatus"
                                    ...
                                    <template v-for="(oddsData, key2) in filterBy(section.odds, 'lay1', 'oname')">
                                        <div class="bl-box back" :key="`layodds${key2}`" :class="[{'no-val':oddsData.odds == 0},
        ...
        <!-- <div class="bet-table">
            <div class="bet-table-header" data-toggle="collapse" :data-target="`#market${index}`" aria-expanded="true">
                ...
                <div class="back back-title bl-title d-none-mobile">Odd</div>
                <div class="back back-title bl-title d-none-mobile">Even</div>
            </div>
