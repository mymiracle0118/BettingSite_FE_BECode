...
<script>
    export default {
        ...
        mounted(){
            if(this.name == 'logo'){
                this.styleClass = {
                    fill: this.getRndColor(),
                    left: `${this.getRndInteger(1,80)}%`,
                    top: this.getRndInteger(-5, 40),
                    height: `${this.getRndInteger(40,100)}px`,
                    opacity: `0.${this.getRndInteger(4,8)}`
                }
            }
            else if(this.name == 'logoMobile'){
                this.styleClass = {
                    fill: this.getRndColor(),
                    left: `${this.getRndInteger(10,55)}%`,
                    top: this.getRndInteger(-5, 30),
                    height: `${this.getRndInteger(20,50)}px`,
                    opacity: `0.${this.getRndInteger(4,8)}`
                }
            }
                ...
                this.styleClass = {
                    fill: this.getRndColor(), 
                    left: `${this.getRndInteger(1,29)}%`, 
                    top: this.getRndInteger(-10,20), 
                    height: `${this.getRndInteger(40,55)}px`,
                    opacity: `0.${this.getRndInteger(4,8)}`
                }
            }
