        ...
        <div class="bet-table">
            <div class="bet-table-header" data-toggle="collapse" :data-target="`#market${index}`">
                ...
                <div class="float-right"> 
                   ...
                   <!--  <a href="javascript:void(0)" class="btn btn-back" @click="$parent.getBookData(marketDataNew.mid, 'Match')">User Book</a> -->
                </div>
            ...
            <div class="bet-table-body collapse show" :id="`market${index}`"
                ...
                <div class="bet-table-row bet-table-row-top">
                    <div class="text-right nation-name">
                        <span class="max-bet">Max:<span v-kval="{size: marketDataNew.iplay ? marketDataNew.maxb : marketDataNew.umaxbof}"></span></span>
                    </div>
                    <div class="back bl-title d-none-mobile">Back</div>
                    <div class="lay bl-title d-none-mobile">Lay</div>
                </div>
