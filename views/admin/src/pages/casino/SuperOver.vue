        ...
        <div class="center-main-container">
            <div class="center-content">
                <div class="casino-container">
                    <div class="casino-table five-cricket super-over detail-page-container">
                        ...
                        <div class="container-fluid container-fluid-5">
                            <div class="row row5">
                                <div class="col-xl-2 banner d-flex align-items-center mb-1">
                                    <template v-if="casinoData && casinoData.scard != 2">
                                        <div class="scorecard"
                                            v-if="casinoData.scard == 1 && scoreboardData.isfinished == '0'">
                                            <div class="scorecard-row">
                                                <div class="score-top-row">
                                                    <div class="score-team">
                                                        <b>{{ scoreboardData.spnnation1 }}</b>
                            ...
                            <div class="casino-video-rid">Round ID: {{ casinoData.gmid }}</div>
                                        ...
                                        <div class="casino-timer">
                                            <Timer v-if="time.total != 0" :totalTime="time.total"
                                                :currentTime="time.current" />
                                        </div>
                                        <div class="casino-video-right-icons">
                                            <div class="casino-video-home-icon" title="Home">
                                                <router-link :to="{name: 'casinolist'}"
            ...
            <div class="right-sidebar" :data-simplebar="!$store.getters.isMobile">
                <div class="card m-b-10 my-bet" id="my-game-bets">
                    <div class="card-header">
                        ...
                        <a href="javascript:void(0)" class="btn btn-back float-right" @click="getViewMoreBets()">View
                            More</a>
                    </div>
                                    ...
                                    <table class="table coupon-table mb-0">
                                        ...
                                        <tbody v-if="userBook != null">
                                            <template v-for="bet in userBook.t2">
                                                <tr
                                                    :class="{'back-border': bet.btype.toLowerCase() == 'back', 'lay-border': bet.btype.toLowerCase() == 'lay'}">
                                                    <td colspan="4">
                                                        <b>{{ bet.mname }}</b>
                                                        <span class="float-right"
                                                            v-format-datetime="{date:bet.pdt}"></span>
                                                    </td>
                                                </tr>
                                                <tr
                                                    :class="{'back-border': bet.btype.toLowerCase() == 'back', 'lay-border': bet.btype.toLowerCase() == 'lay'}">
                ...
                <div class="card mb-2 my-bet cricket-rule">
                    <div class="card-header text-center">
                        <span>ENG vs RSA<br>Inning's Card Rules</span>
                    </div>
                    <div class="card-body">
                        <div class="card">
                            <div class="card-header">
            ...
            <div v-if="$store.getters.isMobile" class="market-show-icon d-none-desktop"
                ...
                <ul class="nav nav-tabs d-inline-block  text-uppercase" role="tablist ">
                    <li class="nav-item d-inline-block" v-for="(marketTab, index) in viewMoreBets.marketList">
                        <a class="nav-link" data-toggle="tab" href="javascript:void(0)"
                            ...
                            :class="{active: viewMoreBets.selectedMarket == marketTab.mid}">{{ marketTab.mname }}</a>
                    </li>
                </ul>
            </template>
                ...
                ServiceApi.callApi("casino/gettoken", {
                    ...
                    .then(response => {
                        if (response.status == 200) {
                            this.tvUrl = '/admin/pages/mediaplayercasino/' + this.gameType + '/' + response.data
                                .token + '?ip=' + IP_ADDRESS;
                        } else {
                            this.tvUrl = ''
                        }
